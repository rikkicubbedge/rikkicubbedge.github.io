(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.grace, 350, 200, 5, 0.6);
        collectable.create(type.db, 400, 370, 2, 0.1);
        collectable.create(type.kennedi, 630, 410, 8, 0.2);
        collectable.create(type.max, 120, 530, 213, 1, 0.5);
